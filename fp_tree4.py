...
"""
python.exe "C:\Users\Kevin\PycharmProjects\AqeelaTugasAkhir\fp_tree4.py" "C:\Users\Kevin\PycharmProjects\AqeelaTugasAkhir\monkey.csv" -s 3
"""
...
if __name__ == '__main__':
    ...
    filteredData = []
    try:
        for itemset, support in find_frequent_itemsets(csv.reader(f), 0, True):
