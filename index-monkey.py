...
python.exe "C:\Users\Kevin\PycharmProjects\TugasAkhir\index-monkey.py"
...
def readFile():
	lines = [line.rstrip('\n') for line in open('C:\\Users\\Kevin\\PycharmProjects\\TugasAkhir\\monkey.csv')]
    ...
    for i in range(len(filteredList)):
        ...
        for L in range(1, len(subset)):
            for resultsubset in combinations(subset, L):
                ...
                print ''
                print subset_string + ' : ' + support_subset
                print left_string + ' : ' + support_left
                ...
                query = 'INSERT INTO rules_monkey(items,result,probability) VALUES("'+left_string+'","'+right_string+'","'+str(support)+'");'
                print query
                print ''
